...
public static class DemoOrderSeeder
{
    ...
    [
        ...
        ON DUPLICATE KEY UPDATE
            ...
            TotalGross = VALUES(TotalGross)
        """,
        // Invoices for orders 926-955 — inserted AFTER those orders exist (FK constraint)
        """
        INSERT INTO Invoices (Id, OrderId, InvoiceNumber, CustomerName, IssueDate, DueDate, TotalNet, TotalVat, TotalGross, CreatedAt) VALUES
        (926, 926, 'DEMO-0002', 'Kulturzentrum ARGEkultur',  DATE_SUB(CURRENT_DATE(),INTERVAL 4 DAY),  DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 4 DAY),INTERVAL 14 DAY), 2425.45, 242.55, 2668.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 4 DAY)),
        (927, 927, 'DEMO-0003', 'Autohaus Stadler',          DATE_SUB(CURRENT_DATE(),INTERVAL 7 DAY),  DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 7 DAY),INTERVAL 14 DAY), 1840.00, 184.00, 2024.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 7 DAY)),
        (928, 928, 'DEMO-0004', 'Seniorenheim Aigen',        DATE_SUB(CURRENT_DATE(),INTERVAL 11 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 11 DAY),INTERVAL 14 DAY), 1170.91, 117.09, 1288.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 11 DAY)),
        (929, 929, 'DEMO-0005', 'StartUp Hub Salzburg',      DATE_SUB(CURRENT_DATE(),INTERVAL 14 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 14 DAY),INTERVAL 14 DAY),  752.73,  75.27,  828.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 14 DAY)),
        (930, 930, 'DEMO-0006', 'Brauerei Kaltenhausen',     DATE_SUB(CURRENT_DATE(),INTERVAL 17 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 17 DAY),INTERVAL 14 DAY), 7109.09, 710.91, 7820.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 17 DAY)),
        (931, 931, 'DEMO-0007', 'Immobilien Eder GmbH',      DATE_SUB(CURRENT_DATE(),INTERVAL 21 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 21 DAY),INTERVAL 14 DAY), 1756.36, 175.64, 1932.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 21 DAY)),
        (932, 932, 'DEMO-0008', 'Volksschule Maxglan',       DATE_SUB(CURRENT_DATE(),INTERVAL 27 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 27 DAY),INTERVAL 14 DAY), 1003.64, 100.36, 1104.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 27 DAY)),
        (933, 933, 'DEMO-0009', 'Golfclub Salzburg',         DATE_SUB(CURRENT_DATE(),INTERVAL 34 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 34 DAY),INTERVAL 14 DAY), 4683.64, 468.36, 5152.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 34 DAY)),
        (934, 934, 'DEMO-0010', 'Rotes Kreuz OV Hallein',   DATE_SUB(CURRENT_DATE(),INTERVAL 39 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 39 DAY),INTERVAL 14 DAY), 3178.18, 317.82, 3496.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 39 DAY)),
        (935, 935, 'DEMO-0011', 'ORF Landesstudio',          DATE_SUB(CURRENT_DATE(),INTERVAL 44 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 44 DAY),INTERVAL 14 DAY), 5436.36, 543.64, 5980.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 44 DAY)),
        (936, 936, 'DEMO-0012', 'Versicherung Allgemein',    DATE_SUB(CURRENT_DATE(),INTERVAL 49 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 49 DAY),INTERVAL 14 DAY), 2341.82, 234.18, 2576.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 49 DAY)),
        (937, 937, 'DEMO-0013', 'Reisebüro Fernweh',         DATE_SUB(CURRENT_DATE(),INTERVAL 55 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 55 DAY),INTERVAL 14 DAY), 1338.18, 133.82, 1472.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 55 DAY)),
        (938, 938, 'DEMO-0014', 'Kunsthaus Salzburg',        DATE_SUB(CURRENT_DATE(),INTERVAL 61 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 61 DAY),INTERVAL 14 DAY), 3512.73, 351.27, 3864.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 61 DAY)),
        (939, 939, 'DEMO-0015', 'IT Consulting Wieser',      DATE_SUB(CURRENT_DATE(),INTERVAL 67 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 67 DAY),INTERVAL 14 DAY),  669.09,  66.91,  736.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 67 DAY)),
        (940, 940, 'DEMO-0016', 'Handwerk Meister GmbH',     DATE_SUB(CURRENT_DATE(),INTERVAL 73 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 73 DAY),INTERVAL 14 DAY), 2592.73, 259.27, 2852.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 73 DAY)),
        (941, 941, 'DEMO-0017', 'Yoga Studio Balance',       DATE_SUB(CURRENT_DATE(),INTERVAL 79 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 79 DAY),INTERVAL 14 DAY),  501.82,  50.18,  552.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 79 DAY)),
        (942, 942, 'DEMO-0018', 'Bergbahn AG',               DATE_SUB(CURRENT_DATE(),INTERVAL 85 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 85 DAY),INTERVAL 14 DAY), 6021.82, 602.18, 6624.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 85 DAY)),
        (943, 943, 'DEMO-0019', 'Steuerberatung Kern',       DATE_SUB(CURRENT_DATE(),INTERVAL 91 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 91 DAY),INTERVAL 14 DAY), 1672.73, 167.27, 1840.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 91 DAY)),
        (944, 944, 'DEMO-0020', 'Tennisclub Nonntal',        DATE_SUB(CURRENT_DATE(),INTERVAL 97 DAY), DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 97 DAY),INTERVAL 14 DAY), 2007.27, 200.73, 2208.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 97 DAY)),
        (945, 945, 'DEMO-0021', 'Galerie Rupertinum',        DATE_SUB(CURRENT_DATE(),INTERVAL 103 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 103 DAY),INTERVAL 14 DAY),3010.91, 301.09, 3312.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 103 DAY)),
        (946, 946, 'DEMO-0022', 'Bauunternehmen Hofer',      DATE_SUB(CURRENT_DATE(),INTERVAL 109 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 109 DAY),INTERVAL 14 DAY),3345.45, 334.55, 3680.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 109 DAY)),
        (947, 947, 'DEMO-0023', 'Landwirtschaft Kogler',     DATE_SUB(CURRENT_DATE(),INTERVAL 115 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 115 DAY),INTERVAL 14 DAY),4014.55, 401.45, 4416.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 115 DAY)),
        (948, 948, 'DEMO-0024', 'Fitness First Salzburg',    DATE_SUB(CURRENT_DATE(),INTERVAL 121 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 121 DAY),INTERVAL 14 DAY),4600.00, 460.00, 5060.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 121 DAY)),
        (949, 949, 'DEMO-0025', 'Anwaltskanzlei Huber',      DATE_SUB(CURRENT_DATE(),INTERVAL 127 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 127 DAY),INTERVAL 14 DAY),3178.18, 317.82, 3496.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 127 DAY)),
        (950, 950, 'DEMO-0026', 'Modeatelier Klein',         DATE_SUB(CURRENT_DATE(),INTERVAL 133 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 133 DAY),INTERVAL 14 DAY),5185.45, 518.55, 5704.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 133 DAY)),
        (951, 951, 'DEMO-0027', 'Stadttheater Salzburg',     DATE_SUB(CURRENT_DATE(),INTERVAL 139 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 139 DAY),INTERVAL 14 DAY),7527.27, 752.73, 8280.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 139 DAY)),
        (952, 952, 'DEMO-0028', 'Biohotel Erika',            DATE_SUB(CURRENT_DATE(),INTERVAL 145 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 145 DAY),INTERVAL 14 DAY), 752.73,  75.27,  828.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 145 DAY)),
        (953, 953, 'DEMO-0029', 'Digitalagentur Pulse',      DATE_SUB(CURRENT_DATE(),INTERVAL 151 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 151 DAY),INTERVAL 14 DAY),2174.55, 217.45, 2392.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 151 DAY)),
        (954, 954, 'DEMO-0030', 'Klinikum Salzburg',         DATE_SUB(CURRENT_DATE(),INTERVAL 157 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 157 DAY),INTERVAL 14 DAY),5687.27, 568.73, 6256.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 157 DAY)),
        (955, 955, 'DEMO-0031', 'Sportverein ASKÖ',          DATE_SUB(CURRENT_DATE(),INTERVAL 163 DAY),DATE_ADD(DATE_SUB(CURRENT_DATE(),INTERVAL 163 DAY),INTERVAL 14 DAY),4516.36, 451.64, 4968.00, DATE_SUB(CURRENT_TIMESTAMP,INTERVAL 163 DAY))
        ON DUPLICATE KEY UPDATE
            CustomerName = VALUES(CustomerName),
            IssueDate = VALUES(IssueDate),
            DueDate = VALUES(DueDate),
