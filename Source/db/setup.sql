...
CREATE TABLE IF NOT EXISTS OrderMenuItems (Id INT NOT NULL AUTO_INCREMENT, OrderId INT NOT NULL, MenuItemId INT NOT NULL, `Count` INT NULL, PRIMARY KEY (Id), UNIQUE KEY uq_t_order_menuitem (OrderId, MenuItemId), CONSTRAINT fk_t_omi_order FOREIGN KEY (OrderId) REFERENCES Orders (Id), CONSTRAINT fk_t_omi_menuitem FOREIGN KEY (MenuItemId) REFERENCES MenuItems (Id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
